...
class PredictionCallback(pl.Callback):
    ...
    def predict_sequence(self, trainer, pl_module: dynamics_models.MDN_RNN, epoch):
        ...
        if pl_module.hparams.visual_model_cls == 'vqvae':
            ...
            base_reconstruction = pl_module.visual_model.reconstruct_only(self.sequence[0][1:])
            ...
            images = torch.stack([self.sequence[0][0,1:], one_step_pov_reconstruction, n_step_pov_reconstruction], dim=1).reshape(((self.seq_len -1) * 4, 3, 64, 64))
